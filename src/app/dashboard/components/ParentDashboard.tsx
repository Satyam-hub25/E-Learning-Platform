...
export default function ParentDashboardComponent() {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <button className="px-4 py-2 bg-white/10 rounded-lg hover:bg-white/20 transition-all text-white">
            📊 Generate Report
          </button>
          <button className="px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg font-semibold hover:shadow-lg transition-all text-white">
            💬 Message Teacher
          </button>
        </div>
      </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-6 mt-3">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-white">Level {childData.level}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-blue-400">⭐</span>
                <span className="text-white">{childData.xp} XP</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-orange-400">🔥</span>
                <span className="text-white">{childData.streak} day streak</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-green-400">⏰</span>
                <span className="text-white">{childData.weeklyHours}h this week</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {activeTab === 'overview' && (
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/10"
          >
            <h3 className="text-xl font-semibold mb-4 text-white">📚 Subject Progress</h3>
          ...
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/10"
          >
            <h3 className="text-xl font-semibold mb-4 text-white">📅 Weekly Activity</h3>
          ...
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/10"
          >
            <h3 className="text-xl font-semibold mb-4 text-white">🏆 Recent Achievements</h3>
          ...
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/10"
          >
            <h3 className="text-xl font-semibold mb-4 text-white">📝 Upcoming Assignments</h3>
            <div className="space-y-3">
      ...
      {activeTab === 'progress' && (
        <div className="text-center py-20">
          ...
          <h3 className="text-2xl font-semibold mb-2 text-white">Detailed Progress Reports</h3>
          <p className="text-white/60 mb-6">Advanced analytics and detailed progress tracking coming soon!</p>
          <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl font-semibold text-white">
      ...
      {activeTab === 'communication' && (
        <div className="text-center py-20">
          <div className="text-6xl mb-4">💬</div>
          <h3 className="text-2xl font-semibold mb-2 text-white">Teacher Communication</h3>
          <p className="text-white/60 mb-6">Direct messaging with teachers and school updates</p>
          <div className="flex gap-4 justify-center">
            <button className="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl font-semibold text-white">
              Message Teacher
            </button>
            <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-xl font-semibold text-white">
              View Announcements
            </button>
          </div>
        </div>
