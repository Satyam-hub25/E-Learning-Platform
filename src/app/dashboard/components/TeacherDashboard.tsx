  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl font-semibold hover:shadow-lg transition-all text-white">
          + Create Assignment
        </button>
      </div>
      ...
      {activeTab === 'students' ? (
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-white">Student Monitoring</h2>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                  <div className="text-center">
                    <div className="text-lg font-bold text-white">{student.streak}</div>
                    <div className="text-xs text-white/60">Day Streak</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-bold text-white">{student.lessonsCompleted}</div>
          ...
          {assignments.map((assignment, index) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                  <div className="text-center">
                    <div className="text-lg font-bold text-white">{assignment.submitted}/{assignment.total}</div>
